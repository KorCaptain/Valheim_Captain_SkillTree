    ...
    public static partial class ConfigTranslations
    {
        private static Dictionary<string, string> GetKoreanKeyNames()
        {
            return new Dictionary<string, string>
            {
                ...
                // ============================================
                ["Archer_MultiShot_ArrowCount"] = "Lv1 멀티샷: 화살 수",
                ["Archer_MultiShot_ArrowConsumption"] = "Lv1 멀티샷: 화살 소모",
                ["Archer_MultiShot_DamagePercent"] = "Lv1 멀티샷: 1발당 공격력 (%)",
                ...
                ["Archer_Lv3_DamagePercent"] = "Lv3 멀티샷: 1발당 공격력 (%)",
                ["Archer_Lv4_BonusArrows"]   = "Lv4 멀티샷: 추가 발사체 수",
                ["Archer_Lv4_DamagePercent"] = "Lv4 멀티샷: 1발당 공격력 (%)",
                ["Archer_Lv5_BonusArrows"]   = "Lv5 멀티샷: 추가 발사체 수",
                ["Archer_Lv5_DamagePercent"] = "Lv5 멀티샷: 1발당 공격력 (%)",
                ["Archer_Lv5_BonusCharges"]  = "Lv5 멀티샷: 추가 발사 회수",
                ["Archer_Lv2_JumpHeightBonus"]     = "Lv2 패시브: 점프 높이 보너스 (%)",
                ...
                ["Rogue_Poison_Range"] = "독 폭발: 범위 (m)",
                ["Rogue_Poison_InstantDamage"] = "독 폭발: 즉시 독데미지",
                ["Rogue_Poison_DotDamage"] = "독 폭발: 초당 DoT 데미지",
                ["Rogue_Poison_DotDuration"] = "독 폭발: DoT 지속시간 (초)",
                ["Rogue_Poison_VFXCount"] = "독 폭발: 횟수",
                ["Rogue_Poison_VFXInterval"] = "독 폭발: 간격 (초)",
                ["Rogue_Lv2_Cooldown"] = "Lv2: 쿨다운 (초)",
                ["Rogue_Lv3_Cooldown"] = "Lv3: 쿨다운 (초)",
                ["Rogue_Lv4_Cooldown"] = "Lv4: 쿨다운 (초)",
                ["Rogue_Lv5_Cooldown"] = "Lv5: 쿨다운 (초)",
                ...
                ["Rogue_Lv2_PoisonDot"] = "Lv2: 독 DoT/초",
                ["Rogue_Lv3_PoisonDot"] = "Lv3: 독 DoT/초",
                ["Rogue_Lv4_PoisonDot"] = "Lv4: 독 DoT/초",
                ["Rogue_Lv5_PoisonDot"] = "Lv5: 독 DoT/초",
                ["Rogue_ShadowStrike_Charges"] = "그림자 일격: 기본 충전",
                ...
                ["Rogue_Lv5_AttackSpeed"] = "Lv5 패시브: 공격속도 (%)",
                ["Rogue_Lv2_StaminaReduction"] = "Lv2 패시브: 스태미나 감소 (%)",
                ...
                // ============================================
                ["Producer_Buff_Cooldown"]      = "제작: 장인의 축복 쿨타임 (초)",
                ["Producer_Buff_Duration"]      = "제작: 장인의 축복 지속시간 (초)",
                ["Producer_Buff_Range"]         = "제작: 장인의 축복 범위 (m)",
                ["Producer_Buff_AttackBonus"]   = "제작: 장인의 축복 공격력 보너스 (%)",
                ["Producer_Buff_MaxHealthBonus"]= "제작: 장인의 축복 최대 체력 보너스 (%)",
                ["Producer_Buff_StaminaCost"]   = "제작: 장인의 축복 스태미나 소모",
                ["Producer_FarmGrid_Lv1"]       = "Lv1: 농사 그리드 크기",
                ["Producer_FarmGrid_Lv2"]       = "Lv2: 농사 그리드 크기",
                ["Producer_Durability_Lv2"]     = "Lv2: 내구도 보너스 (%)",
                ["Producer_MaterialReduction_Lv2"] = "Lv2: 재료 감소 (%)",
                ["Producer_FarmGrid_Lv3"]       = "Lv3: 농사 그리드 크기",
                ["Producer_Durability_Lv3"]     = "Lv3: 내구도 보너스 (%)",
                ["Producer_MaterialReduction_Lv3"] = "Lv3: 재료 감소 (%)",
                ["Producer_EnchantChance_Lv3"]  = "Lv3: 마법부여 확률 (%)",
                ["Producer_EnchantWeaponDmgMin_Lv3"] = "Lv3: 무기 마법부여 최솟값 (%)",
                ["Producer_EnchantWeaponDmgMax_Lv3"] = "Lv3: 무기 마법부여 최댓값 (%)",
                ["Producer_EnchantArmorMin_Lv3"] = "Lv3: 방어구 마법부여 최솟값 (%)",
                ["Producer_EnchantArmorMax_Lv3"] = "Lv3: 방어구 마법부여 최댓값 (%)",
                ["Producer_EnchantHpMin_Lv3"]   = "Lv3: HP 마법부여 최솟값 (%)",
                ["Producer_EnchantHpMax_Lv3"]   = "Lv3: HP 마법부여 최댓값 (%)",
                ["Producer_FarmGrid_Lv4"]       = "Lv4: 농사 그리드 크기",
                ["Producer_Durability_Lv4"]     = "Lv4: 내구도 보너스 (%)",
                ["Producer_MaterialReduction_Lv4"] = "Lv4: 재료 감소 (%)",
                ["Producer_EnchantChance_Lv4"]  = "Lv4: 마법부여 확률 (%)",
                ["Producer_EnchantWeaponDmgMin_Lv4"] = "Lv4: 무기 마법부여 최솟값 (%)",
                ["Producer_EnchantWeaponDmgMax_Lv4"] = "Lv4: 무기 마법부여 최댓값 (%)",
                ["Producer_EnchantArmorMin_Lv4"] = "Lv4: 방어구 마법부여 최솟값 (%)",
                ["Producer_EnchantArmorMax_Lv4"] = "Lv4: 방어구 마법부여 최댓값 (%)",
                ["Producer_EnchantHpMin_Lv4"]   = "Lv4: HP 마법부여 최솟값 (%)",
                ["Producer_EnchantHpMax_Lv4"]   = "Lv4: HP 마법부여 최댓값 (%)",
                ["Producer_FarmGrid_Lv5"]       = "Lv5: 농사 그리드 크기",
                ["Producer_Durability_Lv5"]     = "Lv5: 내구도 보너스 (%)",
                ["Producer_MaterialReduction_Lv5"] = "Lv5: 재료 감소 (%)",
                ["Producer_EnchantChance_Lv5"]  = "Lv5: 마법부여 확률 (%)",
                ["Producer_EnchantWeaponDmgMin_Lv5"] = "Lv5: 무기 마법부여 최솟값 (%)",
                ["Producer_EnchantWeaponDmgMax_Lv5"] = "Lv5: 무기 마법부여 최댓값 (%)",
                ["Producer_EnchantArmorMin_Lv5"] = "Lv5: 방어구 마법부여 최솟값 (%)",
                ["Producer_EnchantArmorMax_Lv5"] = "Lv5: 방어구 마법부여 최댓값 (%)",
                ["Producer_EnchantHpMin_Lv5"]   = "Lv5: HP 마법부여 최솟값 (%)",
                ["Producer_EnchantHpMax_Lv5"]   = "Lv5: HP 마법부여 최댓값 (%)",

    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetEnglish_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["tanker_passive_lv2"] = "HP +{0}%, Dmg taken -{1}%, Shield Block +{2}, Reflect {3}s on hit, Learned prereq skills (Pierce/Combo/FuryHammer/RushSlash/ParryCharge/ShieldCharge/PierceCharge) +1 use in 30s",

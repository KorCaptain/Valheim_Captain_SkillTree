    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetEnglish_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["archer_passive_lv1"] = "Jump +{0}%, Fall -{1}%, Atk Stamina -{2}%, Arrow/Bolt {3}% no-consume, Tamed Heal +{4}/s",
                ["archer_passive_lv2"] = "Jump +{0}%, Poison Resist +{1}%, Atk Stamina -{2}%, Arrow/Bolt {3}% no-consume, Tamed Heal +{4}/s",
                ["archer_passive_lv3"] = "Jump +{0}%, Fall -{1}%, Poison/Cold Resist +{2}%, Atk Stamina -{3}%, Arrow/Bolt {4}% no-consume, Tamed Heal +{5}/s",
                ["archer_passive_lv4"] = "Jump +{0}%, Fall -{1}%, Poison/Cold/Fire Resist +{2}%, Atk Stamina -{3}%, Arrow/Bolt {4}% no-consume, Tamed Heal +{5}/s",
                ["archer_passive_lv5"] = "Jump +{0}%, Fall -{1}%, All Elem Resist +{2}%, Atk Stamina -{3}%, Arrow/Bolt {4}% no-consume, Tamed Heal +{5}/s",
                ...
                ["item_trophy_frosttroll"] = "Troll Trophy",
                ...
                ["berserker_active_desc"] = "Rage: {0}s CD, {1}s duration, ATK +{2}% per 1% HP lost",
                ...
                ["berserker_passive_lv3"] = "HP+{0}, Lv2 + Further rage cooldown/duration improvement",
                ["berserker_passive_lv4"] = "HP+{0}, Lv3 + Further rage cooldown/duration improvement",
                ["berserker_passive_lv5"] = "HP+{0}, Lv4 + Further rage cooldown/duration improvement",
                ...
                ["rogue_tooltip_title"] = "Rogue - Shadow Strike",
                ...
                ["rogue_preview_cd"] = "Cooldown {1}s (lv1 -{0}s)",
                ...
                ["archer_lv2_extra_charge_effect"] = "OneShot/Explosive Arrow: 1 extra use within 30s",
                ["mage_lv2_unlock_cond"] = "Must learn Multi Cast for Lv2 upgrade",
                ...
                ["mage_dungeon_buff_desc"] = "Inside dungeons, this casts a self-buff instead: +{0}% attack damage for {1}s",
                ["mage_dungeon_buff_cast"] = "Attack Boost! (+{0}%, {1}s)",
                // === Mage Level System ===
                ["mage_passive_lv1"] = "AOE dmg {0}%, Cooldown {2}s, Elemental Resist {1}%",
                ["mage_passive_lv2"] = "AOE dmg {0}%, Cooldown {2}s, Multi Cast +1 (30s), Elemental Resist {1}%",
                ...
                ["defense_root_desc"] = "Health +{0}, Helmet Armor +{1}, Attack Power -{2}%",
                ...
                ["defense_root_effect"] = "🛡️ Defense Expert! Health +{0}, Defense +{1}, Attack Power -{2}%",
                ...
                ["mace_knockback_desc2"] = "{0}% chance on hit with a mace to slow the target's movement and attack speed by 30% for 1.5s",
                ...
                ["producer_passive_lv1"] = "Durability+{0}%, Enchant {1}% chance",
                ["producer_passive_lv2"] = "Durability+{0}%, Material-{1}%, Enchant {2}% chance",
                ["producer_passive_lv3"] = "Durability+{0}%, Material-{1}%, Enchant {2}% chance",
                ["producer_passive_lv4"] = "Durability+{0}%, Material-{1}%, Enchant {2}% chance",
                ["producer_passive_lv5"] = "Durability+{0}%, Material-{1}%, Enchant {2}% chance",
                ...
                ["producer_enchant_fire_proc"]         = "✨ Crafting Blessing: Fire Damage Chance +{0}%",
                ["producer_enchant_spirit_proc"]       = "✨ Crafting Blessing: Spirit Damage Chance +{0}%",
                ["producer_enchant_poison_proc"]       = "✨ Crafting Blessing: Poison Damage Chance +{0}%",
                ["producer_enchant_lightning_proc"]    = "✨ Crafting Blessing: Lightning Damage Chance +{0}%",
                ["producer_enchant_frost_proc"]        = "✨ Crafting Blessing: Frost Damage Chance +{0}%",
                ["producer_enchant_polearm_range"]     = "✨ Crafting Blessing: Range +{0}%",
                ...
                ["speed_root_desc"] = "Move speed +{0}%/level (max Lv7)",
                ["speedroot_item_required"] = "Trophies required for Lv{0} upgrade",
                ["speedroot_missing_items"] = "Missing: {0}",
                ["speedroot_max_level"] = "Max level reached",
                ["speedroot_trophy_required"] = "Required: {0} x5",
                ["speedroot_upgrade_requires"] = "Lv{0} Upgrade Items",
                ["speed_root_stat_preview"] = "Move speed +{0}%",
                ...
                ["parry_rush_damage"] = "⚔️ Whirlwind Hit {0}! (+{1}%)",

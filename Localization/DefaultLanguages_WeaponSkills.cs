    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_WeaponSkills()
        {
            return new Dictionary<string, string>
            {
                ...
                ["pierce_charge_upgrade_title"] = "⚔️ 관통 돌격 강화",
                ["pierce_charge_upgrade_confirm"] = "관통 돌격을 Lv{0}으로 강화합니다.\n필요 트로피가 인벤토리에서 소모됩니다.\n계속하시겠습니까?",
                ["pierce_charge_max_level"] = "관통 돌격이 최대 레벨(Lv7)입니다.",
                ["pierce_charge_level_item_required"] = "관통 돌격 Lv{0} 강화에 필요한 트로피가 부족합니다.",
                ["pierce_charge_missing_items"] = "부족한 재료: {0}",
                ["pierce_charge_next_level_req"] = "Lv{0} 강화 조건",
                ["pierce_charge_upgrade_ready"] = "강화 가능",

                ["polearm_whirlwind_upgrade_title"] = "🌪️ 폴암 회오리 강화",
                ["polearm_whirlwind_upgrade_confirm"] = "폴암 회오리를 Lv{0}으로 강화합니다.\n필요 트로피가 인벤토리에서 소모됩니다.\n계속하시겠습니까?",
                ["polearm_whirlwind_max_level"] = "폴암 회오리가 최대 레벨(Lv7)입니다.",
                ["polearm_whirlwind_level_item_required"] = "폴암 회오리 Lv{0} 강화에 필요한 트로피가 부족합니다.",
                ["polearm_whirlwind_missing_items"] = "부족한 재료: {0}",
                ["polearm_whirlwind_next_level_req"] = "Lv{0} 강화 조건",
                ["polearm_whirlwind_upgrade_ready"] = "강화 가능",
        ...
        private static Dictionary<string, string> GetEnglish_WeaponSkills()
        {
            return new Dictionary<string, string>
            {
                ...
                ["pierce_charge_upgrade_title"] = "⚔️ Pierce Charge Upgrade",
                ["pierce_charge_upgrade_confirm"] = "Upgrade Pierce Charge to Lv{0}.\nRequired trophies will be consumed from inventory.\nProceed?",
                ["pierce_charge_max_level"] = "Pierce Charge is at max level (Lv7).",
                ["pierce_charge_level_item_required"] = "Not enough trophies for Pierce Charge Lv{0} upgrade.",
                ...
                ["polearm_whirlwind_upgrade_title"] = "🌪️ Polearm Whirlwind Upgrade",
                ["polearm_whirlwind_upgrade_confirm"] = "Upgrade Polearm Whirlwind to Lv{0}.\nRequired trophies will be consumed from inventory.\nProceed?",
                ["polearm_whirlwind_max_level"] = "Polearm Whirlwind is at max level (Lv7).",
                ["polearm_whirlwind_level_item_required"] = "Not enough trophies for Polearm Whirlwind Lv{0} upgrade.",
                ["polearm_whirlwind_missing_items"] = "Missing: {0}",
                ["polearm_whirlwind_next_level_req"] = "Lv{0} Upgrade Requirements",
                ["polearm_whirlwind_upgrade_ready"] = "Ready to upgrade",

    ...
    public static partial class ConfigTranslations
    {
        private static Dictionary<string, string> GetChineseKeyNames_Part2()
        {
            return new Dictionary<string, string>
            {
                ...
                // === Tier 1: 快速攻击动作 (2) ===
                ["Tier1_QuickStrike_RequiredPoints"] = "Tier 1: [快速攻击动作] 所需点数",
                ["Tier1_AttackMotion"] = "Tier 1: [快速攻击动作] 动作选择",
                ...
                ["Tier8_AssassinHeart_AttackSpeedBonus"] = "Tier 8: [刺客之心] 攻击速度加成 (%)",
                ...
                // === Tier 4: 推击 (2) ===
                ["Tier4_Push_KnockbackChance"] = "Tier 4: [脑震荡] 脑震荡概率 (%)",
                ["Tier4_Push_RequiredPoints"] = "Tier 4: [脑震荡] 所需点数",
                ...
                ["Tier7_ShockwaveSlam_Cooldown"] = "Tier 7-2: [冲击波强击] 冷却时间 (秒)",
                ["Tier7_ShockwaveSlam_StaminaCost"] = "Tier 7-2: [冲击波强击] 体力消耗",
                ["Tier7_ShockwaveSlam_DamagePercent"] = "Tier 7-2: [冲击波强击] 武器攻击力伤害比例 (%)",
                ["Tier7_ShockwaveSlam_LevelBonus"] = "Tier 7-2: [冲击波强击] 等级加成 (%)",
                ["Tier7_ShockwaveSlam_RequiredPoints"] = "Tier 7-2: [冲击波强击] 所需点数",
                ...
                ["Tier6_Whirlwind_DamageReductionPercent"]    = "Tier 6: [旋风] 受到伤害减免 (%)",
                ["Tier6_Whirlwind_DamageReductionLevelBonus"] = "Tier 6: [旋风] 伤害减免等级加成 (%)",
                ...
                ["Mage_Dungeon_Buff_Damage_Bonus"] = "地下城buff：攻击力加成 (%)",
                ["Mage_Dungeon_Buff_Duration"] = "地下城buff：持续时间 (秒)",
                ...
                ["Rogue_Lv1_MoveSpeed"]                = "Lv1 被动: 移动速度 (%)",
                ["Rogue_Lv2_AttackBonus"]              = "Lv2: 攻击增益 (%)",
                ["Rogue_Lv2_AttackSpeed"]              = "Lv2 被动: 攻击速度 (%)",
                ["Rogue_Lv2_BuffDuration"]             = "Lv2: 增益持续时间 (秒)",
                ["Rogue_Lv2_Cooldown"]                 = "Lv2: 冷却时间 (秒)",
                ["Rogue_Lv2_MoveSpeed"]                = "Lv2 被动: 移动速度 (%)",
                ["Rogue_Lv2_PoisonBlasts"]             = "Lv2: 毒爆炸次数",
                ["Rogue_Lv2_PoisonDot"]                = "Lv2: 毒DoT/秒",
                ["Rogue_Lv2_PoisonInstant"]            = "Lv2: 即时毒伤害",
                ["Rogue_Lv2_StaminaReduction"]         = "Lv2 被动: 耐力减少 (%)",
                ["Rogue_Lv3_AttackBonus"]              = "Lv3: 攻击增益 (%)",
                ["Rogue_Lv3_AttackSpeed"]              = "Lv3 被动: 攻击速度 (%)",
                ["Rogue_Lv3_BuffDuration"]             = "Lv3: 增益持续时间 (秒)",
                ["Rogue_Lv3_Cooldown"]                 = "Lv3: 冷却时间 (秒)",
                ["Rogue_Lv3_MoveSpeed"]                = "Lv3 被动: 移动速度 (%)",
                ["Rogue_Lv3_PoisonBlasts"]             = "Lv3: 毒爆炸次数",
                ["Rogue_Lv3_PoisonDot"]                = "Lv3: 毒DoT/秒",
                ["Rogue_Lv3_PoisonInstant"]            = "Lv3: 即时毒伤害",
                ["Rogue_Lv3_StaminaReduction"]         = "Lv3 被动: 耐力减少 (%)",
                ["Rogue_Lv4_AttackBonus"]              = "Lv4: 攻击增益 (%)",
                ["Rogue_Lv4_AttackSpeed"]              = "Lv4 被动: 攻击速度 (%)",
                ["Rogue_Lv4_BuffDuration"]             = "Lv4: 增益持续时间 (秒)",
                ["Rogue_Lv4_Cooldown"]                 = "Lv4: 冷却时间 (秒)",
                ["Rogue_Lv4_MoveSpeed"]                = "Lv4 被动: 移动速度 (%)",
                ["Rogue_Lv4_PoisonBlasts"]             = "Lv4: 毒爆炸次数",
                ["Rogue_Lv4_PoisonDot"]                = "Lv4: 毒DoT/秒",
                ["Rogue_Lv4_PoisonInstant"]            = "Lv4: 即时毒伤害",
                ["Rogue_Lv4_StaminaReduction"]         = "Lv4 被动: 耐力减少 (%)",
                ["Rogue_Lv5_AttackBonus"]              = "Lv5: 攻击增益 (%)",
                ["Rogue_Lv5_AttackSpeed"]              = "Lv5 被动: 攻击速度 (%)",
                ["Rogue_Lv5_BonusCharges"]             = "Lv5: 额外充能",
                ["Rogue_Lv5_BuffDuration"]             = "Lv5: 增益持续时间 (秒)",
                ["Rogue_Lv5_Cooldown"]                 = "Lv5: 冷却时间 (秒)",
                ["Rogue_Lv5_MoveSpeed"]                = "Lv5 被动: 移动速度 (%)",
                ["Rogue_Lv5_PoisonBlasts"]             = "Lv5: 毒爆炸次数",
                ["Rogue_Lv5_PoisonDot"]                = "Lv5: 毒DoT/秒",
                ["Rogue_Lv5_PoisonInstant"]            = "Lv5: 即时毒伤害",
                ["Rogue_Lv5_StaminaReduction"]         = "Lv5 被动: 耐力减少 (%)",
                ["Rogue_Poison_DotDamage"]             = "毒爆炸: DoT伤害/秒",
                ["Rogue_Poison_DotDuration"]           = "毒爆炸: DoT持续时间 (秒)",
                ["Rogue_Poison_InstantDamage"]         = "毒爆炸: 即时伤害",
                ["Rogue_Poison_Range"]                 = "毒爆炸: 范围 (m)",
                ["Rogue_Poison_VFXCount"]              = "毒爆炸: VFX次数",
                ["Rogue_Poison_VFXInterval"]           = "毒爆炸: 间隔 (秒)",
                ["Rogue_ShadowStrike_Charges"]         = "暗影打击: 基础充能",
                ["Tanker_Hp_Bonus_Lv1"]                = "Lv1 被动: HP 加成",
                ["Tanker_Hp_Bonus_Lv2"]                = "Lv2 被动: HP 加成",
                ["Tanker_Hp_Bonus_Lv3"]                = "Lv3 被动: HP 加成",
                ["Tanker_Hp_Bonus_Lv4"]                = "Lv4 被动: HP 加成",
                ["Tanker_Hp_Bonus_Lv5"]                = "Lv5 被动: HP 加成",
                ["Tanker_Lv2_BlockPower"]              = "Lv2 被动: 格挡力量",
                ["Tanker_Lv3_BlockPower"]              = "Lv3 被动: 格挡力量",
                ["Tanker_Lv4_BlockPower"]              = "Lv4 被动: 格挡力量",
                ["Tanker_Lv5_BlockPower"]              = "Lv5 被动: 格挡力量",
                ["Tanker_ReflectDuration_Lv1"]         = "Lv1 被动: 反射持续时间 (秒)",
                ["Tanker_ReflectDuration_Lv2"]         = "Lv2 被动: 反射持续时间 (秒)",
                ["Tanker_ReflectDuration_Lv3"]         = "Lv3 被动: 反射持续时间 (秒)",
                ["Tanker_ReflectDuration_Lv4"]         = "Lv4 被动: 反射持续时间 (秒)",
                ["Tanker_ReflectDuration_Lv5"]         = "Lv5 被动: 反射持续时间 (秒)",
                ["Tier5_OneShot_AoeRadius"]            = "Tier 5: [一击必杀] 范围半径 (m)",
                ["Tier5_PierceCharge_LevelBonus"]      = "Tier 5: [贯穿突击] 每级伤害加成 (%)",
                ...
                ["Tier6_ArrowRain_DungeonBuff_DamageBonus"] = "Tier 6: [箭雨] 地下城buff：攻击力加成 (%)",
                ["Tier6_ArrowRain_DungeonBuff_Duration"] = "Tier 6: [箭雨] 地下城buff：持续时间 (秒)",

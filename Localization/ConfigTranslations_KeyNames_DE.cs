    ...
    public static partial class ConfigTranslations
    {
        ...
        private static Dictionary<string, string> GetGermanKeyNames_Part1()
        {
            return new Dictionary<string, string>
            {
                ...
                // === Neues 4-Phasen-System (Tier1~5) ===
                ["Tier1_Opener_DamageBonus"] = "Tier 1: [Erster Schlag] Schadensbonus (%)",
                ["Tier1_Opener_StaminaReduction"] = "Tier 1: [Erster Schlag] Ausdauerverbrauch red. (%)",
                ["Tier1_Opener_Duration"] = "Tier 1: [Erster Schlag] Dauer (sek)",
                ["Tier1_Opener_Cooldown"] = "Tier 1: [Erster Schlag] Abklingzeit (sek)",
                ...
                ["Tier2_OpenerMagic_StaggerProc"] = "Tier 2-4: [Magie] Erschütterung (1=Aktiv)",
                ["Tier2_OpenerMagic_RequiredPoints"] = "Tier 2-4: [Magie] Benötigte Punkte",
                ["Tier3_Pursuit_DamageBonus"] = "Tier 3: [Verfolgung] Basis-Schadensbonus (%)",
                ["Tier3_Pursuit_ChainDamageBonus"] = "Tier 3: [Verfolgung] Ketten-Schadensbonus (%)",
                ["Tier3_Pursuit_ChainWindow"] = "Tier 3: [Verfolgung] Kettenfenster (sek)",
                ...
                ["Tier5_Frenzy_HitsPerStack"] = "Tier 5: [Raserei] Treffer pro Stapel",
                ["Tier5_Frenzy_Tier6Amplifier"] = "Tier 5: [Raserei] Tier6-Verstärker bei Max-Stapeln",
                ["Tier5_Frenzy_RequiredPoints"] = "Tier 5: [Raserei] Benötigte Punkte",
                ...
                // === Tier 1-1: Kopfschuss (2) ===
                ["Tier1_Headshot_HeadZoneRatio"] = "Tier 1-1: [Kopfschuss] Kopfzone-Verhältnis",
                ["Tier1_FocusedShot_RequiredPoints"] = "Tier 1-1: [Kopfschuss] Benötigte Punkte",

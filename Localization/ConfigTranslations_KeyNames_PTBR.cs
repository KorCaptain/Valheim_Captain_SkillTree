    ...
    public static partial class ConfigTranslations
    {
        ...
        private static Dictionary<string, string> GetPortugueseBrazilianKeyNames_Part1()
        {
            return new Dictionary<string, string>
            {
                ...
                // === Novo sistema 4 fases (Tier1~5) ===
                ["Tier1_Opener_DamageBonus"] = "Tier 1: [Primeiro Golpe] Bônus de Dano (%)",
                ["Tier1_Opener_StaminaReduction"] = "Tier 1: [Primeiro Golpe] Redução de Estamina (%)",
                ["Tier1_Opener_Duration"] = "Tier 1: [Primeiro Golpe] Duração (seg)",
                ["Tier1_Opener_Cooldown"] = "Tier 1: [Primeiro Golpe] Recarga (seg)",
                ...
                ["Tier2_OpenerMagic_StaggerProc"] = "Tier 2-4: [Magia] Proc Stagger (1=Ativo)",
                ["Tier2_OpenerMagic_RequiredPoints"] = "Tier 2-4: [Magia] Pontos Necessários",
                ["Tier3_Pursuit_DamageBonus"] = "Tier 3: [Perseguição] Bônus de Dano Base (%)",
                ["Tier3_Pursuit_ChainDamageBonus"] = "Tier 3: [Perseguição] Bônus de Dano em Cadeia (%)",
                ["Tier3_Pursuit_ChainWindow"] = "Tier 3: [Perseguição] Janela de Cadeia (seg)",
                ...
                ["Tier5_Frenzy_HitsPerStack"] = "Tier 5: [Frenesi] Golpes por Pilha",
                ["Tier5_Frenzy_Tier6Amplifier"] = "Tier 5: [Frenesi] Amplificador Tier6 no Máx.",
                ["Tier5_Frenzy_RequiredPoints"] = "Tier 5: [Frenesi] Pontos Necessários",
                ...
                // === Tier 1-1: Tiro na Cabeça (2) ===
                ["Tier1_Headshot_HeadZoneRatio"] = "Tier 1-1: [Tiro na Cabeça] Proporção da Zona da Cabeça",
                ["Tier1_FocusedShot_RequiredPoints"] = "Tier 1-1: [Tiro na Cabeça] Pontos Necessários",

    ...
    public static partial class ConfigTranslations
    {
        private static Dictionary<string, string> GetGermanKeyNames_Part2()
        {
            return new Dictionary<string, string>
            {
                ...
                // === Tier 1: Schnelle Angriffsbewegung (2) ===
                ["Tier1_QuickStrike_RequiredPoints"] = "Tier 1: [Schnelle Angriffsbewegung] Benötigte Punkte",
                ["Tier1_AttackMotion"] = "Tier 1: [Schnelle Angriffsbewegung] Bewegungsauswahl",
                ...
                ["Tier5_OneShot_SlowReloadMultiplier"] = "Tier 5: [Einschuss] Langsamer Nachlademultiplikator",
                ...
                ["Tier8_AssassinHeart_AttackSpeedBonus"] = "Tier 8: [Assassinenherz] Angriffsgeschwindigkeit-Bonus (%)",
                ...
                ["Tier3_SpinStrike_KnockbackForce"] = "Tier 3-1: [Drehschlag] Rückschlagdistanz (m)",
                ...
                // === Tier 4: Stoß (2) ===
                ["Tier4_Push_KnockbackChance"] = "Tier 4: [Gehirnerschütterung] Gehirnerschütterungschance (%)",
                ["Tier4_Push_RequiredPoints"] = "Tier 4: [Gehirnerschütterung] Benötigte Punkte",
                ...
                ["Tier7_ShockwaveSlam_Cooldown"] = "Tier 7-2: [Schockwellenschlag] Abklingzeit (Sek)",
                ["Tier7_ShockwaveSlam_StaminaCost"] = "Tier 7-2: [Schockwellenschlag] Ausdauerkosten",
                ["Tier7_ShockwaveSlam_DamagePercent"] = "Tier 7-2: [Schockwellenschlag] Waffenschaden (%)",
                ["Tier7_ShockwaveSlam_LevelBonus"] = "Tier 7-2: [Schockwellenschlag] Stufenbonus (%)",
                ["Tier7_ShockwaveSlam_RequiredPoints"] = "Tier 7-2: [Schockwellenschlag] Benötigte Punkte",
                ...
                ["Tier6_Whirlwind_DamageReductionLevelBonus"] = "Tier 6: [Wirbelwind] Schadensreduzierung Stufenbonus (%)",
                ...
                ["Mage_Dungeon_Buff_Damage_Bonus"] = "Dungeon-Buff: Schadensbonus (%)",
                ["Mage_Dungeon_Buff_Duration"] = "Dungeon-Buff: Dauer (Sek.)",
                ...
                ["Berserker_Passive_HealthBonus"] = "Passiv: Max. LP-Bonus (flat)",
                ...
                ["Producer_Durability_Lv1"]          = "Handwerksmeister: Haltbarkeitsbonus Lv1 (%)",
                ["Producer_CraftingSuccessRate_Lv1"] = "Handwerksmeister: Herstellungserfolg Lv1 (%)",
                ["Producer_EnchantChance_Lv1"]       = "Handwerksmeister: Verzauberungschance Lv1 (%)",
                ["Producer_ElementalProcChance_Lv1"] = "Handwerksmeister: Elementarschadenchance Lv1 (%)",
                ["Producer_Durability_Lv2"]          = "Handwerksmeister: Haltbarkeitsbonus Lv2 (%)",
                ["Producer_CraftingSuccessRate_Lv2"] = "Handwerksmeister: Herstellungserfolg Lv2 (%)",
                ["Producer_MaterialReduction_Lv2"]   = "Handwerksmeister: Materialeinsparung Lv2 (%)",
                ["Producer_EnchantChance_Lv2"]       = "Handwerksmeister: Verzauberungschance Lv2 (%)",
                ["Producer_ElementalProcChance_Lv2"] = "Handwerksmeister: Elementarschadenchance Lv2 (%)",
                ["Producer_Durability_Lv3"]          = "Handwerksmeister: Haltbarkeitsbonus Lv3 (%)",
                ["Producer_CraftingSuccessRate_Lv3"] = "Handwerksmeister: Herstellungserfolg Lv3 (%)",
                ...
                ["Producer_ElementalProcChance_Lv3"] = "Handwerksmeister: Elementarschadenchance Lv3 (%)",
                ["Producer_Durability_Lv4"]          = "Handwerksmeister: Haltbarkeitsbonus Lv4 (%)",
                ["Producer_CraftingSuccessRate_Lv4"] = "Handwerksmeister: Herstellungserfolg Lv4 (%)",
                ...
                ["Producer_ElementalProcChance_Lv4"] = "Handwerksmeister: Elementarschadenchance Lv4 (%)",
                ["Producer_Durability_Lv5"]          = "Handwerksmeister: Haltbarkeitsbonus Lv5 (%)",
                ["Producer_CraftingSuccessRate_Lv5"] = "Handwerksmeister: Herstellungserfolg Lv5 (%)",
                ...
                ["Producer_ElementalProcChance_Lv5"] = "Handwerksmeister: Elementarschadenchance Lv5 (%)",
                ...
                // ============================================
                // Fehlende Schlüssel (zur Synchronisierung hinzugefügt)
                // ============================================
                ...
                ["Rogue_Lv1_MoveSpeed"]                = "Lv1 Passiv: Bewegungsgeschwindigkeit (%)",
                ["Rogue_Lv2_AttackBonus"]              = "Lv2: Angriffsverstärkung (%)",
                ["Rogue_Lv2_AttackSpeed"]              = "Lv2 Passiv: Angriffsgeschwindigkeit (%)",
                ["Rogue_Lv2_BuffDuration"]             = "Lv2: Buff-Dauer (Sek)",
                ["Rogue_Lv2_Cooldown"]                 = "Lv2: Abklingzeit (Sek)",
                ["Rogue_Lv2_MoveSpeed"]                = "Lv2 Passiv: Bewegungsgeschwindigkeit (%)",
                ["Rogue_Lv2_PoisonBlasts"]             = "Lv2: Giftexplosionen",
                ["Rogue_Lv2_PoisonDot"]                = "Lv2: Gift DoT/Sek",
                ["Rogue_Lv2_PoisonInstant"]            = "Lv2: Sofort-Giftschaden",
                ["Rogue_Lv2_StaminaReduction"]         = "Lv2 Passiv: Ausdauerreduzierung (%)",
                ["Rogue_Lv3_AttackBonus"]              = "Lv3: Angriffsverstärkung (%)",
                ["Rogue_Lv3_AttackSpeed"]              = "Lv3 Passiv: Angriffsgeschwindigkeit (%)",
                ["Rogue_Lv3_BuffDuration"]             = "Lv3: Buff-Dauer (Sek)",
                ["Rogue_Lv3_Cooldown"]                 = "Lv3: Abklingzeit (Sek)",
                ["Rogue_Lv3_MoveSpeed"]                = "Lv3 Passiv: Bewegungsgeschwindigkeit (%)",
                ["Rogue_Lv3_PoisonBlasts"]             = "Lv3: Giftexplosionen",
                ["Rogue_Lv3_PoisonDot"]                = "Lv3: Gift DoT/Sek",
                ["Rogue_Lv3_PoisonInstant"]            = "Lv3: Sofort-Giftschaden",
                ["Rogue_Lv3_StaminaReduction"]         = "Lv3 Passiv: Ausdauerreduzierung (%)",
                ["Rogue_Lv4_AttackBonus"]              = "Lv4: Angriffsverstärkung (%)",
                ["Rogue_Lv4_AttackSpeed"]              = "Lv4 Passiv: Angriffsgeschwindigkeit (%)",
                ["Rogue_Lv4_BuffDuration"]             = "Lv4: Buff-Dauer (Sek)",
                ["Rogue_Lv4_Cooldown"]                 = "Lv4: Abklingzeit (Sek)",
                ["Rogue_Lv4_MoveSpeed"]                = "Lv4 Passiv: Bewegungsgeschwindigkeit (%)",
                ["Rogue_Lv4_PoisonBlasts"]             = "Lv4: Giftexplosionen",
                ["Rogue_Lv4_PoisonDot"]                = "Lv4: Gift DoT/Sek",
                ["Rogue_Lv4_PoisonInstant"]            = "Lv4: Sofort-Giftschaden",
                ["Rogue_Lv4_StaminaReduction"]         = "Lv4 Passiv: Ausdauerreduzierung (%)",
                ["Rogue_Lv5_AttackBonus"]              = "Lv5: Angriffsverstärkung (%)",
                ["Rogue_Lv5_AttackSpeed"]              = "Lv5 Passiv: Angriffsgeschwindigkeit (%)",
                ["Rogue_Lv5_BonusCharges"]             = "Lv5: Bonusladungen",
                ["Rogue_Lv5_BuffDuration"]             = "Lv5: Buff-Dauer (Sek)",
                ["Rogue_Lv5_Cooldown"]                 = "Lv5: Abklingzeit (Sek)",
                ["Rogue_Lv5_MoveSpeed"]                = "Lv5 Passiv: Bewegungsgeschwindigkeit (%)",
                ["Rogue_Lv5_PoisonBlasts"]             = "Lv5: Giftexplosionen",
                ["Rogue_Lv5_PoisonDot"]                = "Lv5: Gift DoT/Sek",
                ["Rogue_Lv5_PoisonInstant"]            = "Lv5: Sofort-Giftschaden",
                ["Rogue_Lv5_StaminaReduction"]         = "Lv5 Passiv: Ausdauerreduzierung (%)",
                ["Rogue_Poison_DotDamage"]             = "Giftexplosion: DoT-Schaden/Sek",
                ["Rogue_Poison_DotDuration"]           = "Giftexplosion: DoT-Dauer (Sek)",
                ["Rogue_Poison_InstantDamage"]         = "Giftexplosion: Sofortschaden",
                ["Rogue_Poison_Range"]                 = "Giftexplosion: Reichweite (m)",
                ["Rogue_Poison_VFXCount"]              = "Giftexplosion: VFX-Anzahl",
                ["Rogue_Poison_VFXInterval"]           = "Giftexplosion: Intervall (Sek)",
                ["Rogue_ShadowStrike_Charges"]         = "Schattenschlag: Basisladungen",
                ["Tanker_Hp_Bonus_Lv1"]                = "Lv1 Passiv: HP-Bonus",
                ["Tanker_Hp_Bonus_Lv2"]                = "Lv2 Passiv: HP-Bonus",
                ["Tanker_Hp_Bonus_Lv3"]                = "Lv3 Passiv: HP-Bonus",
                ["Tanker_Hp_Bonus_Lv4"]                = "Lv4 Passiv: HP-Bonus",
                ["Tanker_Hp_Bonus_Lv5"]                = "Lv5 Passiv: HP-Bonus",
                ["Tanker_Lv2_BlockPower"]              = "Lv2 Passiv: Blockstärke",
                ["Tanker_Lv3_BlockPower"]              = "Lv3 Passiv: Blockstärke",
                ["Tanker_Lv4_BlockPower"]              = "Lv4 Passiv: Blockstärke",
                ["Tanker_Lv5_BlockPower"]              = "Lv5 Passiv: Blockstärke",
                ["Tanker_ReflectDuration_Lv1"]         = "Lv1 Passiv: Reflektionsdauer (Sek)",
                ["Tanker_ReflectDuration_Lv2"]         = "Lv2 Passiv: Reflektionsdauer (Sek)",
                ["Tanker_ReflectDuration_Lv3"]         = "Lv3 Passiv: Reflektionsdauer (Sek)",
                ["Tanker_ReflectDuration_Lv4"]         = "Lv4 Passiv: Reflektionsdauer (Sek)",
                ["Tanker_ReflectDuration_Lv5"]         = "Lv5 Passiv: Reflektionsdauer (Sek)",
                ["Tier0_SpearExpert_ProcChance"]       = "Tier 0: [Speerspezialist] Aktivierungschance (%)",
                ["Tier0_SpearExpert_SpeedBoost"]       = "Tier 0: [Speerspezialist] Geschwindigkeitsboost (%)",
                ["Tier4-1_StormSlash_ExplosionBonus"]  = "Tier 4-1: [Sturmhieb] Blitzschadenbonus",
                ["Tier5_OneShot_AoeRadius"]            = "Tier 5: [Einschuss] AOE-Radius (m)",
                ["Tier5_PierceCharge_LevelBonus"]      = "Tier 5: [Durchdringungsangriff] Stufenbonus-Schaden (%)",
                ...
                ["Tier6_ArrowRain_DungeonBuff_DamageBonus"] = "Tier 6: [Pfeilregen] Dungeon-Buff: Schadensbonus (%)",
                ["Tier6_ArrowRain_DungeonBuff_Duration"] = "Tier 6: [Pfeilregen] Dungeon-Buff: Dauer (Sek.)",

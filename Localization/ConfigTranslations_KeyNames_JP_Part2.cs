    ...
    public static partial class ConfigTranslations
    {
        private static Dictionary<string, string> GetJapaneseKeyNames_Part2()
        {
            return new Dictionary<string, string>
            {
                ...
                ["Rogue_ElementalResistance_Debuff"] = "パッシブ: 属性耐性増加 (%)",
                ...
                ["Rogue_Lv2_ElementalResist"] = "Lv2 パッシブ: 属性耐性 (%)",
                ["Rogue_Lv3_ElementalResist"] = "Lv3 パッシブ: 属性耐性 (%)",
                ["Rogue_Lv4_ElementalResist"] = "Lv4 パッシブ: 属性耐性 (%)",
                ["Rogue_Lv5_ElementalResist"] = "Lv5 パッシブ: 属性耐性 (%)",
                ...
                // メイジ職業 - レベル別追加キー
                // ============================================
                ["Mage_Lv1_Cooldown"] = "アクティブ: クールダウン Lv1 (秒)",
                ["Mage_Lv2_Cooldown"] = "アクティブ: クールダウン Lv2 (秒)",
                ["Mage_Lv3_Cooldown"] = "アクティブ: クールダウン Lv3 (秒)",
                ["Mage_Lv4_Cooldown"] = "アクティブ: クールダウン Lv4 (秒)",
                ["Mage_Lv5_Cooldown"] = "アクティブ: クールダウン Lv5 (秒)",
                ...
                ["Mage_Lv1_Elemental_Resistance"] = "パッシブ: 属性耐性 Lv1 (%)",
                ["Mage_Lv2_Elemental_Resistance"] = "パッシブ: 属性耐性 Lv2 (%)",
                ["Mage_Lv3_Elemental_Resistance"] = "パッシブ: 属性耐性 Lv3 (%)",
                ["Mage_Lv4_Elemental_Resistance"] = "パッシブ: 属性耐性 Lv4 (%)",
                ["Mage_Lv5_Elemental_Resistance"] = "パッシブ: 属性耐性 Lv5 (%)",
                ["Mage_Lv1_Damage_Multiplier"] = "アクティブ: AOEダメージ倍率 Lv1 (%)",
                ["Mage_Lv2_Damage_Multiplier"] = "アクティブ: AOEダメージ倍率 Lv2 (%)",
                ["Mage_Lv3_Damage_Multiplier"] = "アクティブ: AOEダメージ倍率 Lv3 (%)",
                ["Mage_Lv4_Damage_Multiplier"] = "アクティブ: AOEダメージ倍率 Lv4 (%)",
                ["Mage_Lv5_Damage_Multiplier"] = "アクティブ: AOEダメージ倍率 Lv5 (%)",
            };
        }
    }
}

    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_AttackProduction()
        {
            return new Dictionary<string, string>
            {
                ...
                ["crafting_lv2_desc"] = "15% 확률로 강화+1, 내구도 최대치 15% 증가",
                ["crafting_lv3_name"] = "제작 Lv3",
                ["crafting_lv3_desc"] = "15% 확률로 강화+1, 내구도 최대치 15% 증가",
                ["crafting_lv4_name"] = "제작 Lv4",
                ["crafting_lv4_desc"] = "15% 확률로 강화+1, 내구도 최대치 15% 증가",
                ...
                ["multishot_summoned"] = "🏹 소환 완료! {0}개 발사체 대기중 (30초)",
                ["multishot_launched"] = "🏹 소환 발사체가 적을 추격합니다!",
                ["multishot_expired"] = "소환 발사체가 사라졌습니다 (시간 초과)",
        ...
        private static Dictionary<string, string> GetEnglish_AttackProduction()
        {
            return new Dictionary<string, string>
            {
                ...
                ["crafting_lv2_desc"] = "15% chance +1 upgrade, Max durability +15%",
                ["crafting_lv3_name"] = "Crafting Lv3",
                ["crafting_lv3_desc"] = "15% chance +1 upgrade, Max durability +15%",
                ["crafting_lv4_name"] = "Crafting Lv4",
                ["crafting_lv4_desc"] = "15% chance +1 upgrade, Max durability +15%",
                ...
                ["multishot_summoned"] = "🏹 Summoned! {0} projectiles hovering (30s)",
                ["multishot_launched"] = "🏹 Summoned projectiles homing to target!",
                ["multishot_expired"] = "Summoned projectiles expired (timeout)",

    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_AttackProduction()
        {
            return new Dictionary<string, string>
            {
                ...
                ["tooltip_passive"] = "패시브",
                ["tooltip_reload_penalty"] = "재장전 속도 -{0}% 패널티",
                ...
                ["crafting_lv2_desc"] = "15% 확률로 강화+1, 내구도 최대치 50% 증가",
                ["crafting_lv3_name"] = "제작 Lv3",
                ["crafting_lv3_desc"] = "15% 확률로 강화+1, 내구도 최대치 75% 증가",
                ["crafting_lv4_name"] = "제작 Lv4",
                ["crafting_lv4_desc"] = "15% 확률로 강화+1, 내구도 최대치 100% 증가",
        ...
        private static Dictionary<string, string> GetEnglish_AttackProduction()
        {
            return new Dictionary<string, string>
            {
                ...
                ["tooltip_reload_penalty"] = "Reload speed -{0}% penalty",
                ...
                ["crafting_lv2_desc"] = "15% chance +1 upgrade, Max durability +50%",
                ["crafting_lv3_name"] = "Crafting Lv3",
                ["crafting_lv3_desc"] = "15% chance +1 upgrade, Max durability +75%",
                ["crafting_lv4_name"] = "Crafting Lv4",
                ["crafting_lv4_desc"] = "15% chance +1 upgrade, Max durability +100%",

    ...
    public static partial class ConfigTranslations
    {
        private static Dictionary<string, string> GetEnglishKeyNames()
        {
            return new Dictionary<string, string>
            {
                ...
                // ============================================
                ["Archer_MultiShot_ArrowCount"] = "Lv1 Multishot: Arrow Count",
                ["Archer_MultiShot_ArrowConsumption"] = "Lv1 Multishot: Arrow Consumption",
                ["Archer_MultiShot_DamagePercent"] = "Lv1 Multishot: Damage Per Arrow (%)",
                ...
                ["Archer_Lv2_DamagePercent"] = "Lv2 Multishot: Damage Per Arrow (%)",
                ["Archer_Lv3_BonusArrows"]   = "Lv3 Multishot: Bonus Arrow Count",
                ["Archer_Lv3_DamagePercent"] = "Lv3 Multishot: Damage Per Arrow (%)",
                ["Archer_Lv4_BonusArrows"]   = "Lv4 Multishot: Bonus Arrow Count",
                ["Archer_Lv4_DamagePercent"] = "Lv4 Multishot: Damage Per Arrow (%)",
                ["Archer_Lv5_BonusArrows"]   = "Lv5 Multishot: Bonus Arrow Count",
                ["Archer_Lv5_DamagePercent"] = "Lv5 Multishot: Damage Per Arrow (%)",
                ["Archer_Lv5_BonusCharges"]  = "Lv5 Multishot: Bonus Shot Count",
                ["Archer_Lv2_JumpHeightBonus"]     = "Lv2 Passive: Jump Height Bonus (%)",
                ["Archer_Lv3_JumpHeightBonus"]     = "Lv3 Passive: Jump Height Bonus (%)",
                ["Archer_Lv4_JumpHeightBonus"]     = "Lv4 Passive: Jump Height Bonus (%)",
                ["Archer_Lv5_JumpHeightBonus"]     = "Lv5 Passive: Jump Height Bonus (%)",
                ["Archer_Lv3_FallDamageReduction"] = "Lv3 Passive: Fall Damage Reduction (%)",
                ...
                // Producer Job Skills
                // ============================================
                ["Producer_Buff_Cooldown"] = "Lv1 Blessing: Cooldown (sec)",
                ["Producer_Buff_Duration"] = "Lv1 Blessing: Duration (sec)",
                ["Producer_Buff_Range"] = "Lv1 Blessing: Range (m)",
                ["Producer_Buff_AttackBonus"] = "Lv1 Blessing: Attack Bonus (%)",
                ["Producer_Buff_MaxHealthBonus"] = "Lv1 Blessing: Max HP Bonus (%)",
                ["Producer_Buff_StaminaCost"] = "Lv1 Blessing: Stamina Cost",
                ["Producer_FarmGrid_Lv1"] = "Lv1 Passive: Farm Grid Count",
                ["Producer_FarmGrid_Lv2"] = "Lv2 Passive: Farm Grid Count",
                ["Producer_Durability_Lv2"] = "Lv2 Passive: Durability Bonus (%)",
                ["Producer_MaterialReduction_Lv2"] = "Lv2 Passive: Material Reduction (%)",
                ["Producer_FarmGrid_Lv3"] = "Lv3 Passive: Farm Grid Count",
                ...
                ["Producer_EnchantWeaponDmgMin_Lv3"] = "Lv3 Enchant: Weapon Dmg Min (%)",
                ["Producer_EnchantWeaponDmgMax_Lv3"] = "Lv3 Enchant: Weapon Dmg Max (%)",
                ["Producer_EnchantArmorMin_Lv3"] = "Lv3 Enchant: Armor Min (%)",
                ["Producer_EnchantArmorMax_Lv3"] = "Lv3 Enchant: Armor Max (%)",
                ["Producer_EnchantHpMin_Lv3"] = "Lv3 Enchant: HP Min (%)",
                ["Producer_EnchantHpMax_Lv3"] = "Lv3 Enchant: HP Max (%)",
                ["Producer_FarmGrid_Lv4"] = "Lv4 Passive: Farm Grid Count",
                ...
                ["Producer_EnchantWeaponDmgMin_Lv4"] = "Lv4 Enchant: Weapon Dmg Min (%)",
                ["Producer_EnchantWeaponDmgMax_Lv4"] = "Lv4 Enchant: Weapon Dmg Max (%)",
                ["Producer_EnchantArmorMin_Lv4"] = "Lv4 Enchant: Armor Min (%)",
                ["Producer_EnchantArmorMax_Lv4"] = "Lv4 Enchant: Armor Max (%)",
                ["Producer_EnchantHpMin_Lv4"] = "Lv4 Enchant: HP Min (%)",
                ["Producer_EnchantHpMax_Lv4"] = "Lv4 Enchant: HP Max (%)",
                ["Producer_FarmGrid_Lv5"] = "Lv5 Passive: Farm Grid Count",
                ...
                ["Producer_EnchantWeaponDmgMin_Lv5"] = "Lv5 Enchant: Weapon Dmg Min (%)",
                ["Producer_EnchantWeaponDmgMax_Lv5"] = "Lv5 Enchant: Weapon Dmg Max (%)",
                ["Producer_EnchantArmorMin_Lv5"] = "Lv5 Enchant: Armor Min (%)",
                ["Producer_EnchantArmorMax_Lv5"] = "Lv5 Enchant: Armor Max (%)",
                ["Producer_EnchantHpMin_Lv5"] = "Lv5 Enchant: HP Min (%)",
                ["Producer_EnchantHpMax_Lv5"] = "Lv5 Enchant: HP Max (%)",

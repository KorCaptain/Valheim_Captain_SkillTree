    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["producer_passive_lv1"] = "농사 그리드 {0}칸, 내구도+{1}%, 제작 성공+{2}%",
                ["producer_passive_lv2"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 성공+{3}%",
                ["producer_passive_lv3"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 마법부여 {3}% 확률, 제작 성공+{4}%",
                ["producer_passive_lv4"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 마법부여 {3}% 확률, 제작 성공+{4}%",
                ["producer_passive_lv5"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 마법부여 {3}% 확률, 제작 성공+{4}%",
                ...
                ["mage_passive_lv2"] = "AOE 데미지 {0}%, 쿨타임 {2}초, 연속 발사 +1회 (30초 이내), 속성 저항 {1}%",
                ...
                ["tanker_lv2_skill_prereq_required"] = "분노의 망치 / 돌진베기 / 패링돌격 / 방패돌진 / 꿰뚫는창 / 연창공 중 1개를 배워야 합니다",
                ["tanker_lv2_skill_required"] = "분노의 망치 / 돌진베기 / 패링돌격 / 방패돌진 / 꿰뚫는창 / 연창공 중 1개 이상 필요",
                ["tanker_level_req_items"] = "Lv{0} 필요 아이템",
                ["tanker_taunt_effect"] = "도발 {0}m, {1}초",
                ["tanker_passive_lv1"] = "생명력 +{0}%, 피해감소 {1}%, 피격시 {2}초간 반사",
                ["tanker_passive_lv2"] = "추가 체력 +{0}%, 피해감소 {1}%, 방패 막기 방어력 +{2}, 피격시 {3}초간 반사, 창(꿰뚫는창/연창공) H키 30초 내 1회 추가 사용",
        ...
        private static Dictionary<string, string> GetEnglish_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["archer_passive_lv2"] = "Jump +{0}%, Poison Resist +{1}%, OneShot/ExplosiveArrow +1 extra use",
                ...
                ["mage_passive_lv2"] = "AOE dmg {0}%, Cooldown {2}s, Extra Cast +1 (30s), Elemental Resist {1}%",
                ...
                ["producer_passive_lv1"] = "Farm Grid {0} cells, Durability+{1}%, Craft Success+{2}%",
                ["producer_passive_lv2"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Craft Success+{3}%",
                ["producer_passive_lv3"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Enchant {3}% chance, Craft Success+{4}%",
                ["producer_passive_lv4"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Enchant {3}% chance, Craft Success+{4}%",
                ["producer_passive_lv5"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Enchant {3}% chance, Craft Success+{4}%",
                ...
                ["tanker_lv2_skill_prereq_required"] = "Must learn one of: Fury Hammer, Rush Slash, Parry Charge, Shield Charge, Spear Pierce, or Spear Combo",
                ["tanker_lv2_skill_required"] = "Requires 1 of: Fury Hammer, Rush Slash, Parry Charge, Shield Charge, Spear Pierce, or Spear Combo",
                ...
                ["tanker_passive_lv2"] = "HP +{0}%, Dmg taken -{1}%, Shield Block +{2}, Reflect for {3}s on hit, Spear (Pierce/Combo) H-key +1 use in 30s",

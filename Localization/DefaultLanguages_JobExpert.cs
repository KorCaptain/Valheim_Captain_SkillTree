    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["producer_passive_lv1"] = "내구도+{0}%, 제작 성공+{1}%",
                ["producer_passive_lv2"] = "내구도+{0}%, 재료-{1}%, 제작 성공+{2}%",
                ["producer_passive_lv3"] = "내구도+{0}%, 재료-{1}%, 제작 마법부여 {2}% 확률, 제작 성공+{3}%",
                ["producer_passive_lv4"] = "내구도+{0}%, 재료-{1}%, 제작 마법부여 {2}% 확률, 제작 성공+{3}%",
                ["producer_passive_lv5"] = "내구도+{0}%, 재료-{1}%, 제작 마법부여 {2}% 확률, 제작 성공+{3}%",

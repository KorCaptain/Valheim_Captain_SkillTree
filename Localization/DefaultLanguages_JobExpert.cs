    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["producer_passive_lv1"] = "농사 그리드 {0}칸",
                ["producer_passive_lv2"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%",
                ["producer_passive_lv3"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 마법부여 {3}% 확률",
                ["producer_passive_lv4"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 마법부여 {3}% 확률",
                ["producer_passive_lv5"] = "농사 그리드 {0}칸, 내구도+{1}%, 재료-{2}%, 제작 마법부여 {3}% 확률",
        ...
        private static Dictionary<string, string> GetEnglish_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["producer_passive_lv1"] = "Farm Grid {0} cells",
                ["producer_passive_lv2"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%",
                ["producer_passive_lv3"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Enchant {3}% chance",
                ["producer_passive_lv4"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Enchant {3}% chance",
                ["producer_passive_lv5"] = "Farm Grid {0} cells, Durability+{1}%, Material-{2}%, Enchant {3}% chance",

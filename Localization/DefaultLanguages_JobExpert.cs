    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["mage_passive_lv2"] = "AOE 데미지 {0}%, 쿨타임 {2}초, 이중시전 +1회 (30초 이내), 속성 저항 {1}%",
                ...
                ["berserker_passive_lv4"] = "체력+{0}, Lv3 + 체력 {6}% 이하 시 공격력 +{5}%",
                ["berserker_passive_lv5"] = "체력+{0}, Lv4 + 죽음의 무시 강화 (쿨 -{7}분 단축, 무적 +{8}초)",

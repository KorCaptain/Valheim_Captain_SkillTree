    ...
    public static partial class DefaultLanguages
    {
        private static Dictionary<string, string> GetKorean_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["tanker_lv2_skill_prereq_required"] = "분노의 망치 / 돌진베기 / 패링돌격 / 방패돌진 중 1개를 배워야 합니다",
        ...
        private static Dictionary<string, string> GetEnglish_JobExpert()
        {
            return new Dictionary<string, string>
            {
                ...
                ["tanker_lv2_skill_prereq_required"] = "Must learn one of: Fury Hammer, Rush Slash, Parry Charge, or Shield Charge",

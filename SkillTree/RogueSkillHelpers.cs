    ...
    public static partial class RogueSkills
    {
        ...
        public static string GetRogueLevelCostText(int lv)
        {
            try
            {
                return lv switch
                {
                    1 => $"{CaptainSkillTree.Localization.L.Get("item_trophy_greydwarfbrute")} x1 + {CaptainSkillTree.Localization.L.Get("item_eikthyr_trophy")} x1 + {CaptainSkillTree.Localization.L.Get("item_coins")} x{SkillTreeConfig.GetJobLevelCost(1)}",
                    ...
                    3 => $"{CaptainSkillTree.Localization.L.Get("item_trophy_hatchling")} x1 + {CaptainSkillTree.Localization.L.Get("item_trophy_theelder")} x1 + {CaptainSkillTree.Localization.L.Get("item_trophy_bonemass")} x1 + {CaptainSkillTree.Localization.L.Get("item_coins")} x{SkillTreeConfig.GetJobLevelCost(3)}",

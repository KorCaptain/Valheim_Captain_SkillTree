    ...
    public static class RangedSkillData
    {
        ...
        public static void RegisterRangedSkills()
        {
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Crossbow_Config.CrossbowExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Crossbow_Config.CrossbowStep2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Crossbow_Config.CrossbowBalancedAimRequiredPointsValue,
                RequiredPointsResolver = () => Crossbow_Config.CrossbowBalancedAimRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Crossbow_Config.CrossbowRapidReloadRequiredPointsValue,
                RequiredPointsResolver = () => Crossbow_Config.CrossbowRapidReloadRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Crossbow_Config.CrossbowHonestShotRequiredPointsValue,
                RequiredPointsResolver = () => Crossbow_Config.CrossbowHonestShotRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Crossbow_Config.CrossbowStep4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Crossbow_Config.CrossbowRapidFireLv2RequiredPointsValue,
                RequiredPointsResolver = () => Crossbow_Config.CrossbowRapidFireLv2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Crossbow_Config.CrossbowFinalStrikeRequiredPointsValue,
                RequiredPointsResolver = () => Crossbow_Config.CrossbowFinalStrikeRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Crossbow_Config.CrossbowOneShotRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Crossbow_Config.CrossbowIceBreathRequiredPointsValue,
                MaxLevel = 7,
                Tier = 7,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowFocusShotRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowMultishotRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowStep3RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Bow_Config.BowSilentStrikeRequiredPointsValue,
                RequiredPointsResolver = () => Bow_Config.BowSilentStrikeRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowStep4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Bow_Config.BowHuntingInstinctRequiredPointsValue,
                RequiredPointsResolver = () => Bow_Config.BowHuntingInstinctRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowStep5RequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.BowExplosiveArrowRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Bow_Config.ArrowRainRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffFocusRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffStreamRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffAmpRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffFrostRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffFireRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffLightningRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffLuckManaRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Staff_Config.StaffDoubleCastRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            // Step 6-2: 힐 (액티브 스킬) — Lv1~7 업그레이드 시스템
            manager.AddSkill(new SkillNode {
                Id = "staff_Step6_heal",
                ...
                RequiredPointsResolver = () => Staff_Config.StaffHealRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
        ...
        {
            return ArrowRain_Tooltip.GetTooltip();
        }
        ...
        {
            return CrossbowIceBreath_Tooltip.GetTooltip();
        }

        public static string GetOneShotTooltip()
        {
            return CrossbowOneShot_Tooltip.GetTooltip();
        }
    }
}
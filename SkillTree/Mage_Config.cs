...
namespace CaptainSkillTree.SkillTree
{
    ...
    public static class Mage_Config
    {
        ...
        public static ConfigEntry<int> MageAOEMaxTargets;                // 최대 타겟 수 (기본: 6)
        ...
        public static int MageAOEMaxTargetsValue => (int)SkillTreeConfig.GetEffectiveValue("Mage_AOE_Max_Targets", (float)MageAOEMaxTargets.Value);
        ...
        public static void InitializeMageConfig(ConfigFile config)
        {
            try
            {
                ...
                MageAOEMaxTargets = SkillTreeConfig.BindServerSync(config,
                    "Mage Job Skills",
                    "Mage_AOE_Max_Targets",
                    6,
                    SkillTreeConfig.GetConfigDescription("Mage_AOE_Max_Targets")
                );
        ...
        private static void RegisterMageEventHandlers()
        {
            try
            {
                ...
                MageAOEMaxTargets.SettingChanged += (sender, args) => Mage_Tooltip.UpdateMageTooltip();
        ...
        public static void LogMageConfigValues()
        {
            try
            {
                ...
                Plugin.Log.LogInfo($"[메이지 컨피그] 최대 타겟: {MageAOEMaxTargetsValue}마리");

    ...
    public static class SpeedSkillData
    {
        public static void RegisterSpeedSkills()
        {
            ...
            manager.AddSkill(new SkillNode {
                ...
                DescriptionArgs = new object[] { Speed_Config.SpeedRootMoveSpeedPerLevelValue },
                RequiredPoints = Speed_Config.SpeedRootPointsPerLevelValue,
                RequiredPointsResolver = () => Speed_Config.SpeedRootPointsPerLevelValue,
                MaxLevel = 7,
                Tier = 0,
                ...
                RequiredPlayerLevelResolver = (targetLv) => Speed_Config.GetSpeedRootRequiredPlayerLevel(targetLv),
                ApplyEffect = (lv) => {
                    var player = Player.m_localPlayer;
                    if (player != null) {
                        float totalBonus = lv * Speed_Config.SpeedRootMoveSpeedPerLevelValue;
                        SkillEffect.ShowSkillEffectText(player,
                            L.Get("speed_root_effect", totalBonus),
                            new Color(0.2f, 0.9f, 1f), SkillEffect.SkillEffectTextType.Combat);
                        Plugin.Log.LogInfo($"[속도 전문가] Lv{lv} 투자 완료: +{totalBonus}% 이동속도");
                    }
                }
            });
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep1RequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep2_MeleeFlowRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep2_CrossbowExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep2_BowExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep2_MobileCastRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep3_Practitioner1RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep3_Practitioner2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep4_EnergizerRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep4_CaptainRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep5RequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep6_DexterityRequiredPointsValue,
                MaxLevel = 1,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep6_EnduranceRequiredPointsValue,
                MaxLevel = 1,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep6_IntellectRequiredPointsValue,
                MaxLevel = 1,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep7RequiredPointsValue,
                MaxLevel = 1,
                Tier = 7,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep8_MeleeAccelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 8,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep8_CrossbowAccelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 8,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep8_BowAccelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 8,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Speed_Config.SpeedStep8_CastAccelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 8,

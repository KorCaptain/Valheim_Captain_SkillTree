...
{
    // 꿰뚫는 창(spear_Step5_penetrate) 레벨 시스템
    // Lv1: 에기크쉬르 + 멧돼지 트로피 / Lv2~7: 보스 트로피 + 바이옴 트로피
    public partial class SkillTreeManager
    {
        public bool HasSpearPenetrateLevelItems(int targetLevel)
        {
        ...
        public List<string> GetMissingSpearPenetrateItems(int targetLevel)
        {
            var player = Player.m_localPlayer;
        ...
        private void ConsumeSpearPenetrateLevelItems(int targetLevel)
        {
            var player = Player.m_localPlayer;

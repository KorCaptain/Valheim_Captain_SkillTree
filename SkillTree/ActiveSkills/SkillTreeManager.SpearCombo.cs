...
{
    // 연공창(spear_Step5_combo) 레벨 시스템
    // Lv1~7: 보스 트로피 + 바이옴 트로피 소모
    public partial class SkillTreeManager
    {
        public bool HasSpearComboLevelItems(int targetLevel)
        {
        ...
        public List<string> GetMissingSpearComboItems(int targetLevel)
        {
            var player = Player.m_localPlayer;
        ...
        private void ConsumeSpearComboLevelItems(int targetLevel)
        {
            var player = Player.m_localPlayer;

...
namespace CaptainSkillTree.SkillTree
{
    ...
    {
        public bool HasStaffHealLevelItems(int targetLevel)
        {
        ...
        public List<string> GetMissingStaffHealItems(int targetLevel)
        {
            var player = Player.m_localPlayer;
        ...
        private void ConsumeStaffHealLevelItems(int targetLevel)
        {
            var player = Player.m_localPlayer;

    ...
    public static class MeleeSkillData
    {
        public static void RegisterMeleeSkills()
        {
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeEvasionRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeMoveSpeedRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeAttackSpeedRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeCritRateRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeCombatDamageRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeExecutionRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeAssassinationRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeAssassinHeartRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Knife_Config.KnifeStackExplosionRequiredPointsValue,
                MaxLevel = 7,
                Tier = 7,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
                Position = swordBase,
                Category = "근접",
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordStep1FastSlashRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordStep1CounterRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordStep3RiposteRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordStep2ComboSlashRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordStep3AllInOneRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.SwordStep4TrueDuelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                RequiredPointsResolver = () => Sword_Config.RushSlashRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode
            {
                ...
                DescriptionArgs = new object[] { 5, 8, 12 },
                RequiredPoints = Sword_Config.SwordStep5DefenseSwitchRequiredPointsValue,
                RequiredPointsResolver = () => Sword_Config.SwordStep5DefenseSwitchRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Spear_Config.SpearExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Spear_Config.SpearStep1RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                DescriptionArgs = new object[] { Spear_Config.SpearStep1AttackMotionValue },
                RequiredPoints = Spear_Config.SpearStep1RequiredPointsValue,
                RequiredPointsResolver = () => Spear_Config.SpearStep1RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Spear_Config.SpearStep2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                DescriptionArgs = new object[] { Spear_Config.SpearStep3EvasionBonusValue, Spear_Config.SpearStep3EvasionStaminaReductionValue },
                RequiredPoints = Spear_Config.SpearStep3RequiredPointsValue,
                RequiredPointsResolver = () => Spear_Config.SpearStep3RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Spear_Config.SpearStep4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Spear_Config.SpearPenetrateRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Spear_Config.SpearComboRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmSpinWheelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmPolearmBoostRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmHeroStrikeRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmAreaComboRequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmGroundWheelRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmMoonSlashRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmSuppressRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmKingRequiredPointsValue,
                MaxLevel = 7,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Polearm_Config.PolearmWhirlwindRequiredPointsValue,
                MaxLevel = 7,
                Tier = 7,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Mace_Config.MaceExpertRequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Mace_Config.MaceStep2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                DescriptionArgs = new object[] { Mace_Config.MaceStep3SpinDamageBonusValue, Mace_Config.MaceStep3SpinRangeValue, Mace_Config.MaceStep3SpinKnockbackForceValue },
                RequiredPoints = Mace_Config.MaceStep3GuardRequiredPointsValue,
                RequiredPointsResolver = () => Mace_Config.MaceStep3GuardRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Mace_Config.MaceStep3HeavyRequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Mace_Config.MaceStep4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Mace_Config.MaceStep5TankRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                DescriptionArgs = new object[] { Mace_Config.MaceStep5DpsDamageBonusValue },
                RequiredPoints = Mace_Config.MaceStep5DpsRequiredPointsValue,
                RequiredPointsResolver = () => Mace_Config.MaceStep5DpsRequiredPointsValue,
                MaxLevel = 1,
                Tier = 5,
            ...
            manager.AddSkill(new SkillNode {
                ...
                DescriptionArgs = new object[] { Mace_Config.MaceStep6AttackSpeedBonusValue },
                RequiredPoints = Mace_Config.MaceStep6RequiredPointsValue,
                RequiredPointsResolver = () => Mace_Config.MaceStep6RequiredPointsValue,
                MaxLevel = 1,
                Tier = 6,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPointsResolver = () => Mace_Config.FuryHammerRequiredPointsValue,
                MaxLevel = 7,
                Tier = 7,
                ...
                NextNodes = new List<string> { "mace_Step7_shockwave_slam" },
                ApplyEffect = (lv) => { }
            });

            // 7-2단계: 충격파 강타 (G키 액티브) - 방패돌진이 방어 트리로 이전되며 그 자리를 대체
            manager.AddSkill(new SkillNode {
                Id = "mace_Step7_shockwave_slam",
                NameKey = "mace_skill_shockwave_slam",
                DescriptionKey = "mace_desc_shockwave_slam",
                DescriptionArgs = new object[] { },
                RequiredPoints = Mace_Config.ShockwaveSlamRequiredPointsValue,
                RequiredPointsResolver = () => Mace_Config.ShockwaveSlamRequiredPointsValue,
                MaxLevel = 7,
                Tier = 7,

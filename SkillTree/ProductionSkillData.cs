    ...
    public static class ProductionSkillData
    {
        public static void RegisterProductionSkills()
        {
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.ProductionRootRequiredPointsValue,
                MaxLevel = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.ProductionStep1RequiredPointsValue,
                MaxLevel = 1,
                Tier = 1,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.WoodcuttingLv2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.GatheringLv2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.MiningLv2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
                Position = new Vector2(45, -215),
                Category = "생산",
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.CraftingLv2RequiredPointsValue,
                MaxLevel = 1,
                Tier = 2,
                Position = new Vector2(110, -215),
                Category = "생산",
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.WoodcuttingLv3RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.GatheringLv3RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.MiningLv3RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
                Position = new Vector2(45, -255),
                Category = "생산",
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.CraftingLv3RequiredPointsValue,
                MaxLevel = 1,
                Tier = 3,
                Position = new Vector2(110, -255),
                Category = "생산",
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.WoodcuttingLv4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.GatheringLv4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.MiningLv4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
                Position = new Vector2(45, -295),
                Category = "생산",
            ...
            manager.AddSkill(new SkillNode {
                ...
                RequiredPoints = Production_Config.CraftingLv4RequiredPointsValue,
                MaxLevel = 1,
                Tier = 4,
                Position = new Vector2(110, -295),
                Category = "생산",

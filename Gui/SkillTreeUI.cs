...
namespace CaptainSkillTree.Gui
{
    ...
    public class SkillTreeUI : MonoBehaviour
    {
        ...
        /// <summary>
        /// 폭발화살 Lv2+ 업그레이드 확인 다이얼로그
        /// </summary>
        private void ShowExplosiveArrowUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("ExplosiveArrowUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("explosive_arrow_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.85f, 0f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("explosive_arrow_upgrade_confirm", targetLevel);
        ...
        /// <summary>
        /// 화살비 Lv2+ 업그레이드 확인 다이얼로그
        /// </summary>
        private void ShowArrowRainUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("ArrowRainUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("arrow_rain_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.85f, 0f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("arrow_rain_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                ...
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("bow_Step6_arrow_rain");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowIceBreathUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            confirmDialog = new GameObject("IceBreathUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.05f, 0.10f, 0.25f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.05f, 0.10f, 0.30f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("icebreath_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(0.5f, 0.85f, 1f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            titleText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("icebreath_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.10f, 0.20f, 0.60f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("crossbow_ice_breath");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowDualCastUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("DualCastUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.6f, 0.2f, 0.9f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.08f, 0.05f, 0.20f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.15f, 0.05f, 0.30f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("dualcast_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(0.85f, 0.5f, 1f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            titleText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("dualcast_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.40f, 0.10f, 0.70f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("staff_Step6_dual_cast");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        /// <summary>
        /// 약점폭발 Lv2+ 업그레이드 확인 다이얼로그 (주황/적색 테마)
        /// </summary>
        private void ShowStackExplosionUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("StackExplosionUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.8f, 0.3f, 0.1f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.18f, 0.06f, 0.02f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.30f, 0.08f, 0.02f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("stack_explosion_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.55f, 0.1f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            titleText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("stack_explosion_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.55f, 0.15f, 0.02f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("knife_step10_stack_explosion");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowAssassinHeartUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("AssassinHeartUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.1f, 0.05f, 0.2f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.05f, 0.02f, 0.12f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.12f, 0.05f, 0.25f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("assassin_heart_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(0.6f, 0.3f, 1f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            titleText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("assassin_heart_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.2f, 0.05f, 0.4f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("knife_step9_assassin_heart");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowRushSlashUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("RushSlashUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.05f, 0.15f, 0.25f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.02f, 0.08f, 0.15f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.05f, 0.15f, 0.3f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("rush_slash_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("rush_slash_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.05f, 0.25f, 0.5f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("sword_step5_finalcut");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowWhirlwindUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            confirmDialog = new GameObject("WhirlwindUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("whirlwind_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(0.3f, 0.8f, 1f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("whirlwind_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                ...
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("sword_step5_defswitch");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowShieldChargeUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.2f, 0.1f, 0.05f, 0.85f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.3f, 0.15f, 0.05f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.4f, 0.2f, 0.05f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
        ...
        private void ShowFuryHammerUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("FuryHammerUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.25f, 0.05f, 0.02f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.15f, 0.03f, 0.01f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.5f, 0.1f, 0.05f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("fury_hammer_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.8f, 0.2f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("fury_hammer_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.6f, 0.1f, 0.05f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("mace_Step7_fury_hammer");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowPenetrateUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("PenetrateUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.05f, 0.1f, 0.25f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.02f, 0.06f, 0.15f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.05f, 0.2f, 0.5f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("penetrate_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.8f, 0.2f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("penetrate_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.05f, 0.25f, 0.55f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("spear_Step5_penetrate");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowComboUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("ComboUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("combo_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.8f, 0.2f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("combo_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                ...
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("spear_Step5_combo");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowPierceChargeUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("PierceChargeUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.2f, 0.15f, 0.05f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.08f, 0.06f, 0.02f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.5f, 0.35f, 0.05f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("pierce_charge_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.8f, 0.2f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("pierce_charge_upgrade_confirm", targetLevel);
            contentText.fontSize = 16;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.5f, 0.35f, 0.05f, 1f), darkBgGo.transform, () => {
                PlayConfirmSound();
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("polearm_step5_king");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        private void ShowPolearmWhirlwindUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            var dialogImage = dialogPanel.AddComponent<Image>();
            dialogImage.color = new Color(0.05f, 0.2f, 0.15f, 0.85f);
            ...
            var darkBgImage = darkBgGo.AddComponent<Image>();
            darkBgImage.color = new Color(0.02f, 0.08f, 0.06f, 0.97f);
            ...
            var titleBarImage = titleBarGo.AddComponent<Image>();
            titleBarImage.color = new Color(0.05f, 0.45f, 0.3f, 1f);
            titleBarImage.raycastTarget = false;
            ...
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(0.2f, 1f, 0.8f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            titleText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                ...
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("polearm_step6_whirlwind");
                mgr.ConfirmInvestments();
                nodeUI.RefreshNodeStates();
                RefreshUI();
            });
        ...
        /// </summary>
        private void ShowProducerUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            if (confirmDialog != null)
                DestroyImmediate(confirmDialog);

            confirmDialog = new GameObject("ProducerUpgradeDialog");
            confirmDialog.transform.SetParent(panel.transform, false);
            ...
            titleObj.transform.SetParent(darkBgGo.transform, false);
            var titleText = titleObj.AddComponent<UnityEngine.UI.Text>();
            titleText.text = L10n.Get("producer_upgrade_title");
            titleText.fontSize = 20;
            titleText.fontStyle = FontStyle.Bold;
            titleText.color = new Color(1f, 0.85f, 0f, 1f);
            titleText.alignment = TextAnchor.MiddleCenter;
            ...
            contentObj.transform.SetParent(darkBgGo.transform, false);
            var contentText = contentObj.AddComponent<UnityEngine.UI.Text>();
            contentText.text = L10n.Get("producer_upgrade_confirm", targetLevel);
            contentText.fontSize = 20;
            contentText.color = Color.white;
            contentText.alignment = TextAnchor.MiddleCenter;
            contentText.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                ...
                HideResetConfirmDialog();
                var mgr = SkillTree.SkillTreeManager.Instance;
                mgr.AddPendingInvestment("Producer");
                mgr.ConfirmInvestments();
                CaptainSkillTree.SkillTree.Producer_Tooltip.UpdateProducerTooltip();
                nodeUI.SuppressBadge("Producer");
                nodeUI.RefreshNodeStates();
                if (capturedNodeRect != null)
                    StartCoroutine(PlayProducerLevelUpAnimation(capturedNodeRect, targetLevel));
                RefreshUI();
            });
        ...
        private InvestResult CanInvestWithMessage(CaptainSkillTree.SkillTree.SkillNode node)
        {
            ...
            {
                // 폭발화살 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("explosive_arrow_max_level"));
                bool isAdminEA = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminEA && !manager.HasExplosiveArrowLevelItems(targetLevel))
                {
                    var missing = manager.GetMissingExplosiveArrowItems(targetLevel);
                    var msg = L10n.Get("explosive_arrow_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("explosive_arrow_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "bow_Step6_arrow_rain" && currentLevel >= 1)
            {
                // 화살비 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("arrow_rain_max_level"));
                ...
                {
                    var missing = manager.GetMissingArrowRainItems(targetLevel);
                    var msg = L10n.Get("arrow_rain_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("arrow_rain_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            ...
            {
                // 빙결폭발탄 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("icebreath_max_level"));
                ...
                {
                    var missing = manager.GetMissingIceBreathItems(targetLevel);
                    var msg = L10n.Get("icebreath_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("icebreath_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "staff_Step6_dual_cast" && currentLevel >= 1)
            {
                // 이중시전 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("dualcast_max_level"));
                ...
                {
                    var missing = manager.GetMissingDualCastItems(targetLevel);
            ...
            else if (node.Id == "knife_step10_stack_explosion" && currentLevel >= 1)
            {
                // 약점폭발 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("stack_explosion_max_level"));
                ...
                {
                    var missing = manager.GetMissingStackExplosionItems(targetLevel);
                    var msg = L10n.Get("stack_explosion_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("stack_explosion_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "knife_step9_assassin_heart" && currentLevel >= 1)
            {
                // 암살자의 심장 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("assassin_heart_max_level"));
                bool isAdminAH = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminAH && !manager.HasAssassinHeartLevelItems(targetLevel))
                {
                    var missing = manager.GetMissingAssassinHeartItems(targetLevel);
                    var msg = L10n.Get("assassin_heart_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("assassin_heart_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "sword_step5_finalcut" && currentLevel >= 1)
            {
                // 돌진베기 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("rush_slash_max_level"));
                bool isAdminRS = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminRS && !manager.HasRushSlashLevelItems(targetLevel))
                {
                    var missing = manager.GetMissingRushSlashItems(targetLevel);
                    var msg = L10n.Get("rush_slash_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("rush_slash_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "sword_step5_defswitch" && currentLevel >= 1)
            {
                // 회오리베기 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("whirlwind_max_level"));
                bool isAdminWW = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminWW && !manager.HasWhirlwindLevelItems(targetLevel))
                {
            ...
            else if (node.Id == "mace_Step7_guardian_heart" && currentLevel >= 1)
            {
                // 방패돌진 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("shield_charge_max_level"));
                bool isAdminSC = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminSC && !manager.HasShieldChargeLevelItems(targetLevel))
                {
            ...
            else if (node.Id == "mace_Step7_fury_hammer" && currentLevel >= 1)
            {
                // 분노의 심장 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("fury_hammer_max_level"));
                bool isAdminFH = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminFH && !manager.HasFuryHammerLevelItems(targetLevel))
                {
                    var missing = manager.GetMissingFuryHammerItems(targetLevel);
                    var msg = L10n.Get("fury_hammer_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("fury_hammer_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "spear_Step5_penetrate" && currentLevel >= 1)
            {
                // 꿰뚫는 창 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("penetrate_max_level"));
                bool isAdminPen = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminPen && !manager.HasPenetrateItems(targetLevel))
                {
                    var missing = manager.GetMissingPenetrateItems(targetLevel);
                    var msg = L10n.Get("penetrate_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("penetrate_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "spear_Step5_combo" && currentLevel >= 1)
            {
                // 연공창 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("combo_max_level"));
                bool isAdminCombo = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminCombo && !manager.HasComboItems(targetLevel))
                {
                    var missing = manager.GetMissingComboItems(targetLevel);
                    var msg = L10n.Get("combo_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("combo_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
            else if (node.Id == "polearm_step5_king" && currentLevel >= 1)
            {
                // 관통 돌격 Lv2+ 업그레이드: 트로피 체크 (어드민은 면제)
                int targetLevel = currentLevel + 1;
                if (targetLevel > 7)
                    return new InvestResult(false, L10n.Get("pierce_charge_max_level"));
                bool isAdminPierce = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                if (!isAdminPierce && !manager.HasPierceChargeItems(targetLevel))
                {
                    var missing = manager.GetMissingPierceChargeItems(targetLevel);
                    var msg = L10n.Get("pierce_charge_level_item_required", targetLevel);
                    if (missing.Count > 0)
                        msg += "\n" + L10n.Get("pierce_charge_missing_items", string.Join(", ", missing));
                    return new InvestResult(false, msg);
                }
            }
        ...
        private void InvestPoint(CaptainSkillTree.SkillTree.SkillNode node)
        {
            ...
            else
            {
                ...
                // 폭발화살 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "bow_Step6_critboost" && manager.GetSkillLevel("bow_Step6_critboost") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("bow_Step6_critboost") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("explosive_arrow_max_level"));
                        return;
                    }
                    ...
                    if (isAdminExplosive || manager.HasExplosiveArrowLevelItems(targetLevel))
                    {
                        ...
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectEA = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowExplosiveArrowUpgradeConfirmDialog(targetLevel, nodeRectEA);
                        return;
                    }
                    else
                    {
                ...
                // 화살비 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "bow_Step6_arrow_rain" && manager.GetSkillLevel("bow_Step6_arrow_rain") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("bow_Step6_arrow_rain") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("arrow_rain_max_level"));
                        return;
                    }
                    bool isAdminAR = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    ...
                    if (isAdminAR || manager.HasArrowRainLevelItems(targetLevel))
                    {
                        ...
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectAR = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowArrowRainUpgradeConfirmDialog(targetLevel, nodeRectAR);
                        return;
                    }
                    else
                    {
                ...
                {
                    int targetLevel = manager.GetSkillLevel("crossbow_ice_breath") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("icebreath_max_level"));
                        return;
                    }
                    bool isAdminIB = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    ...
                    if (isAdminIB || manager.HasIceBreathLevelItems(targetLevel))
                    {
                        ...
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectIB = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowIceBreathUpgradeConfirmDialog(targetLevel, nodeRectIB);
                        return;
                    }
                    else
                    {
                ...
                // 이중시전 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "staff_Step6_dual_cast" && manager.GetSkillLevel("staff_Step6_dual_cast") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("staff_Step6_dual_cast") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("dualcast_max_level"));
                        return;
                    }
                    bool isAdminDC = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    ...
                    if (isAdminDC || manager.HasDualCastLevelItems(targetLevel))
                    {
                        ...
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectDC = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowDualCastUpgradeConfirmDialog(targetLevel, nodeRectDC);
                        return;
                    }
                    else
                    {
                ...
                // 약점폭발 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "knife_step10_stack_explosion" && manager.GetSkillLevel("knife_step10_stack_explosion") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("knife_step10_stack_explosion") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("stack_explosion_max_level"));
                        return;
                    }
                    bool isAdminSE = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    ...
                    if (isAdminSE || manager.HasStackExplosionLevelItems(targetLevel))
                    {
                        ...
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectSE = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowStackExplosionUpgradeConfirmDialog(targetLevel, nodeRectSE);
                        return;
                    }
                    else
                    {
                ...
                // 암살자의 심장 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "knife_step9_assassin_heart" && manager.GetSkillLevel("knife_step9_assassin_heart") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("knife_step9_assassin_heart") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("assassin_heart_max_level"));
                        return;
                    }
                    bool isAdminAH = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminAH && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminAH || manager.HasAssassinHeartLevelItems(targetLevel))
                    {
                        RectTransform nodeRectAH = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectAH = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowAssassinHeartUpgradeConfirmDialog(targetLevel, nodeRectAH);
                        return;
                    }
                    else
                    {
                ...
                // 돌진베기 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "sword_step5_finalcut" && manager.GetSkillLevel("sword_step5_finalcut") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("sword_step5_finalcut") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("rush_slash_max_level"));
                        return;
                    }
                    bool isAdminRS = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminRS && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminRS || manager.HasRushSlashLevelItems(targetLevel))
                    {
                        RectTransform nodeRectRS = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectRS = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowRushSlashUpgradeConfirmDialog(targetLevel, nodeRectRS);
                        return;
                    }
                    else
                    {
                ...
                // 회오리베기 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "sword_step5_defswitch" && manager.GetSkillLevel("sword_step5_defswitch") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("sword_step5_defswitch") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("whirlwind_max_level"));
                        return;
                    }
                    bool isAdminWW = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminWW && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminWW || manager.HasWhirlwindLevelItems(targetLevel))
                    {
                        RectTransform nodeRectWW = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectWW = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowWhirlwindUpgradeConfirmDialog(targetLevel, nodeRectWW);
                        return;
                    }
                    else
                    {
                ...
                // 방패돌진 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "mace_Step7_guardian_heart" && manager.GetSkillLevel("mace_Step7_guardian_heart") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("mace_Step7_guardian_heart") + 1;
                    if (targetLevel > 7)
                    {
                    ...
                    bool isAdminSC = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminSC && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminSC || manager.HasShieldChargeLevelItems(targetLevel))
                    {
                        RectTransform nodeRectSC = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectSC = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowShieldChargeUpgradeConfirmDialog(targetLevel, nodeRectSC);
                        return;
                    }
                    else
                    {
                ...
                // 분노의 심장 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "mace_Step7_fury_hammer" && manager.GetSkillLevel("mace_Step7_fury_hammer") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("mace_Step7_fury_hammer") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("fury_hammer_max_level"));
                        return;
                    }
                    bool isAdminFH = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminFH && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminFH || manager.HasFuryHammerLevelItems(targetLevel))
                    {
                        RectTransform nodeRectFH = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectFH = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowFuryHammerUpgradeConfirmDialog(targetLevel, nodeRectFH);
                        return;
                    }
                    else
                    {
                ...
                // 꿰뚫는 창 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "spear_Step5_penetrate" && manager.GetSkillLevel("spear_Step5_penetrate") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("spear_Step5_penetrate") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("penetrate_max_level"));
                        return;
                    }
                    bool isAdminPen = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminPen && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminPen || manager.HasPenetrateItems(targetLevel))
                    {
                        RectTransform nodeRectPen = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectPen = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowPenetrateUpgradeConfirmDialog(targetLevel, nodeRectPen);
                        return;
                    }
                    else
                    {
                ...
                // 연공창 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "spear_Step5_combo" && manager.GetSkillLevel("spear_Step5_combo") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("spear_Step5_combo") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("combo_max_level"));
                        return;
                    }
                    bool isAdminCombo = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminCombo && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminCombo || manager.HasComboItems(targetLevel))
                    {
                        RectTransform nodeRectCombo = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectCombo = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowComboUpgradeConfirmDialog(targetLevel, nodeRectCombo);
                        return;
                    }
                    else
                    {
                ...
                // 관통 돌격 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "polearm_step5_king" && manager.GetSkillLevel("polearm_step5_king") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("polearm_step5_king") + 1;
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("pierce_charge_max_level"));
                        return;
                    }
                    bool isAdminPierce = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminPierce && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminPierce || manager.HasPierceChargeItems(targetLevel))
                    {
                        RectTransform nodeRectPierce = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                            if (nodeObj != null) nodeRectPierce = nodeObj.GetComponent<RectTransform>();
                        }
                        ShowPierceChargeUpgradeConfirmDialog(targetLevel, nodeRectPierce);
                        return;
                    }
                    else
                    {
                ...
                if (node.Id == "polearm_step6_whirlwind" && manager.GetSkillLevel("polearm_step6_whirlwind") >= 1)
                {
                    ...
                    if (targetLevel > 7)
                    {
                        tooltipUI.ShowWarning(L10n.Get("whirlwind_upgrade_max_level"));
                        return;
                    }
                    bool isAdminWhirl = CaptainSkillTree.MMO_System.CaptainLevelConfig.IsAdminModeActive();
                    if (!isAdminWhirl && manager.GetAvailablePoints(false) < node.RequiredPoints)
                    {
                        tooltipUI.ShowWarning(L10n.Get("skill_insufficient_points_detail", node.RequiredPoints, manager.GetAvailablePoints(false)));
                        return;
                    }
                    if (isAdminWhirl || manager.HasWhirlwindItems(targetLevel))
                    {
                        RectTransform nodeRectWhirl = null;
                        if (nodeUI != null && nodeUI.nodeObjects.ContainsKey(node.Id))
                        {
                            var nodeObj = nodeUI.nodeObjects[node.Id];
                ...
                // 제작 전문가 Lv1+ 업그레이드: 확인 다이얼로그 표시
                if (node.Id == "Producer" && manager.GetSkillLevel("Producer") >= 1)
                {
                    int targetLevel = manager.GetSkillLevel("Producer") + 1;
                    if (targetLevel > 5)
                    {
                    ...
                    if (isAdminProducer || manager.HasProducerLevelItems(targetLevel))
                    {
                        ...
                        ShowProducerUpgradeConfirmDialog(targetLevel, nodeRect);
                        return;
                    }
                    else
                    {

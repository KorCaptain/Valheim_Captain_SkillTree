...
namespace CaptainSkillTree.Gui
{
    ...
    public partial class SkillTreeUI
    {
        ...
        private void ShowDualCastUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            borderImage.color = new Color(0.6f, 0.2f, 0.9f, 0.85f);
            ...
            titleBar.AddComponent<Image>().color = new Color(0.15f, 0.05f, 0.30f, 1f);
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.40f, 0.10f, 0.70f, 1f), darkBg.transform, () =>
                {
                    PlayConfirmSound();

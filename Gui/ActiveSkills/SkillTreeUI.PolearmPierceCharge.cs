...
namespace CaptainSkillTree.Gui
{
    ...
    public partial class SkillTreeUI
    {
        ...
        private InvestResult CheckPierceChargeInvest(SkillTree.SkillNode node, int currentLevel)
        {
            ...
            if (!isAdmin && !SkillTree.SkillTreeManager.Instance.HasPierceChargeItems(targetLevel))
            {
        ...
        private bool HandlePierceChargeClick(SkillTree.SkillNode node)
        {
            ...
            if (isAdmin || manager.HasPierceChargeItems(targetLevel))
            {
        ...
        private void ShowPierceChargeUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            borderImage.color = new Color(0.2f, 0.15f, 0.05f, 0.85f);
            ...
            titleBar.AddComponent<Image>().color = new Color(0.5f, 0.35f, 0.05f, 1f);
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.5f, 0.35f, 0.05f, 1f), darkBg.transform, () =>
                {
                    PlayConfirmSound();

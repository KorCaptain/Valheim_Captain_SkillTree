...
namespace CaptainSkillTree.Gui
{
    ...
    public partial class SkillTreeUI
    {
        ...
        private void ShowAssassinHeartUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            borderImage.color = new Color(0.1f, 0.05f, 0.2f, 0.85f);
            ...
            titleBar.AddComponent<Image>().color = new Color(0.12f, 0.05f, 0.25f, 1f);
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.2f, 0.05f, 0.4f, 1f), darkBg.transform, () =>
                {
                    PlayConfirmSound();

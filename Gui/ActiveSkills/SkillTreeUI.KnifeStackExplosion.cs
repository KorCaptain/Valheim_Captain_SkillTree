...
namespace CaptainSkillTree.Gui
{
    ...
    public partial class SkillTreeUI
    {
        ...
        private void ShowStackExplosionUpgradeConfirmDialog(int targetLevel, RectTransform nodeRect)
        {
            ...
            borderImage.color = new Color(0.8f, 0.3f, 0.1f, 0.85f);
            ...
            titleBar.AddComponent<Image>().color = new Color(0.30f, 0.08f, 0.02f, 1f);
            ...
            confirmButton = CreateLuxuryButton("ConfirmButton", L10n.Get("ui_confirm"),
                new Vector2(-68f, -102f), new Color(0.55f, 0.15f, 0.02f, 1f), darkBg.transform, () =>
                {
                    PlayConfirmSound();
